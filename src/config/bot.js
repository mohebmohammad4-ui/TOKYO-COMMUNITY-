...
import { PermissionFlagsBits } from 'discord.js'; // تم استيراد الصلاحيات الحديثة هنا
...
// =========================
// COUNTER CHANNELS (تم إصلاح المشاكل هنا ✅)
// =========================
counters: {
defaults: {
name: "{name} Counter",
...
permissions: {
// استخدام الإشارات الحديثة لتفادي كراش الصلاحيات
...
// جلب دقيق لعدد البوتات الحقيقي بدون الاعتماد الكامل على كاش عشوائي
getCount: (guild) => guild.members.cache.filter((m) => m.user.bot).size.toString() || "0",
},
members_only: {
name: "👤 Humans",
description: "Total human members (non-bots)",
// حساب آمن ومضمون 100% بدون كراش الاستضافة
getCount: (guild) => {
